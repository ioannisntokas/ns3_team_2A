...
| Μέθοδος                               | Σκοπός                               |
+=======================================+=====================================+
| Προκαθορισμένες τιμές Attribute καθο- | Επηρεάζει όλα τα μελλοντικά στιγμιό-|
| ρίζονται όταν Attributes ορίζονται σε | τυπα.                               |
| :cpp:func:`GetTypeId ()`.             |                                     |
+---------------------------------------+-------------------------------------+
| | :cpp:class:`CommandLine`            | Επηρεάζει όλα τα μελλοντικά στιγμιό-|
| | :cpp:func:`Config::SetDefault()`    | τυπα.                               |
| | :cpp:class:`ConfigStore`            |                                     |
+---------------------------------------+-------------------------------------+
...
+---------------------------------------+-------------------------------------+
| | :cpp:func:`MyClass::SetX ()`        | Μεταβάλλει το συγκεκριμένο στιγμιό- |
| | :cpp:func:`Object::SetAttribute ()` | τυπο. Γενικά αυτός είναι ο μόνος    |
| | :cpp:func:`Config::Set()`           | τρόπος για να προγραμματιστεί η     |
|                                       | αλλαγή ενός στιγμιότυπου όταν η     |
|                                       | προσομοίωση τρέχει.                 |
+---------------------------------------+-------------------------------------+
